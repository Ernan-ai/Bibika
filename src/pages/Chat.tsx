...
const Chat = () => {
  ...
  const autoResponses = [
    ...
    "Я передам ваш запрос в соответствующий отдел. Ожидайте ответа в течение 15 минут.",
    "Понял вас! Давайте решим этот вопрос вместе. Можете предоставить больше деталей?",
    "Отличный вопрос! Позвольте мне найти для вас наиболее актуальную информацию.",
    "Я зафиксировал вашу проблему. Наша команда работает над решением подобных вопросов."
  ];
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: '#6b7280' }}>
              Онлайн • Обычно отвечает в течение нескольких минут
            </Typography>
          </Box>
        </Box>
      </Box>
